...
class TestBase(unittest.TestCase):
    ...
    def test_init_base_obj_1(self):
        '''creating an instance of the class Base without passing the id'''
        obj = Base()
        obj2 = Base()
    ...
    def test_saving_to_file_empty_list(self):
        """Test saving empty list and loading from empty file"""
    ...
    def test_saving_to_file_None(self):
        """
        Test passing the save_to_file method None and loading it
        """
